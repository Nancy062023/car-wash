...
export default function CarWashWebsite() {
  ...
  const testimonials: Testimonial[] = [
    ...
    { 
      ...
      rating: 3, 
      text: 'Great service for my Bolero! Looks brand new after the wash in Delhi.', 
      location: 'Delhi' 
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50">
      ...
      <div className="bg-gradient-to-r from-sky-800 to-slate-900 text-white py-16">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/2 relative h-96 md:h-[500px] animate-fadeIn">
            <Image
              src="/man.jpg"
              alt="Car Wash Banner"
              fill
          ...
          <div className="md:w-1/2 text-center md:text-left animate-slideInRight">
            ...
            <button
              onClick={() => {
                const vehiclesSection = document.querySelector('#vehicles') as HTMLElement | null;
                if (vehiclesSection) {
                  window.scrollTo({ top: vehiclesSection.offsetTop, behavior: 'smooth' });
                }
              }}
      ...
      {!selectedVehicle ? (
        ...
        <div>
          ...
          {/* Locations Section */}
          <div className="container mx-auto px-4 py-16 bg-white">
            <h3 className="text-3xl font-bold text-center text-slate-800 mb-4 animate-fadeIn">Our Locations</h3>
            <p className="text-center text-slate-600 mb-12 text-lg">Serving you across Delhi NCR and Bihar</p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {locations.map((location, idx) => (
                <div
                  key={idx}
                  className="bg-gradient-to-br from-sky-50 to-blue-50 p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-slideInUp"
                  style={{ animationDelay: `${idx * 0.2}s` }}
                >
                  <h4 className="text-xl font-bold text-sky-800 mb-2">{location.name}</h4>
